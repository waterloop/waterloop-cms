    ...
    return knex('groups').del()
      .then(function () {
        ...
        return knex('groups').insert([
          {id: 1, group_key: '023ckvvd39fxiix', last_updated: parseTimeFromRequest(Date.now())},
          {id: 2, group_key: '03mzq4wv38e7d6w', last_updated: parseTimeFromRequest(Date.now())},
          {id: 3, group_key: '0147n2zr1nb4vgp', last_updated: parseTimeFromRequest(Date.now())}
        ]);
      });
};
}else{
